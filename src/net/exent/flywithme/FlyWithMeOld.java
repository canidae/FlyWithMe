...
public class FlyWithMeOld extends FragmentActivity {
    ...
    private enum LayoutView {
        MAP {
            ...
            public void drawView(final FlyWithMe activity) {
                ...
                if (view == null) {
                    view = activity.getLayoutInflater().inflate(R.layout.takeoff_map, null);
                    ((SupportMapFragment) activity.getSupportFragmentManager().findFragmentById(R.id.takeoffMapFragment)).setRetainInstance(true);

                    GoogleMap map = ((SupportMapFragment) activity.getSupportFragmentManager().findFragmentById(R.id.takeoffMapFragment)).getMap();
                    if (map == null)
                        return;
        ...
        TAKEOFF_LIST {
            ...
            public void drawView(final FlyWithMe activity) {
                ...
                if (view == null)
                    view = activity.getLayoutInflater().inflate(R.layout.fly_with_me, null);
                activity.setContentView(view);
                activeView.setupLocationListener(activity);

                ImageButton mapButton = (ImageButton) activity.findViewById(R.id.mapButton);
            ...
            protected void updateLocation(final FlyWithMe activity) {
                ...
                ListView takeoffsView = (ListView) activity.findViewById(R.id.takeoffListView);
        ...
        TAKEOFF_DETAIL {
            public void drawView(final FlyWithMe activity) {
                ...
                if (view == null)
                    view = activity.getLayoutInflater().inflate(R.layout.takeoff_details, null);
                activity.setContentView(view);

                ImageButton mapButton = (ImageButton) activity.findViewById(R.id.takeoffDetailsNavigationButton);
                mapButton.setOnClickListener(new OnClickListener() {
                    public void onClick(View v) {
                ...
                */
                ...
                TextView takeoffName = (TextView) activity.findViewById(R.id.takeoffDetailsName);
                TextView takeoffCoordAslHeight = (TextView) activity.findViewById(R.id.takeoffDetailsCoordAslHeight);
                TextView takeoffDescription = (TextView) activity.findViewById(R.id.takeoffDetailsDescription);
