...
public class NoaaProxy {
    ...
    private static final String NOAA_URL = "https://www.ready.noaa.gov";
    private static final String NOAA_METGRAM_CONF = "&metdata=GFS&mdatacfg=GFS&metext=gfsf&nhrs=96&type=user&wndtxt=2&Field1=FLAG&Level1=0&Field2=FLAG&Level2=5&Field3=FLAG&Level3=7&Field4=FLAG&Level4=9&Field5=TCLD&Level5=0&Field6=MSLP&Level6=0&Field7=T02M&Level7=0&Field8=TPPA&Level8=0&Field9=%20&Level9=0&Field10=%20&Level10=0&textonly=No&gsize=96&pdf=No";
    ...
    public static void main(String... args) throws Exception {
        ...
        try (FileOutputStream fos = new FileOutputStream("meteogram.gif")) {
            fos.write(fetchMeteogram(63.0f, 10.0f));
            fos.close();
        }
    }
